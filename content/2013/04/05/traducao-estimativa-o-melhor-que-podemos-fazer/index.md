...
* Tratar estimativas como promessas leva a equipes conservadoras e resultados frustrantes.
...
O tomador de decisão sabe que todas essas estimativas são estimativas, e usa o melhor julgamento para colocar valor nelas. Mas existe uma área chave que ele não conhece muito sobre: quanto desse produto pode ser feito, em qual data, por quanto dinheiro? Essa é uma questão técnica e isso precisa ser respondido por pessoas técnicas.

Sim, claro que nós também não sabemos. Nós realmente não sabemos quanto vai levar. Mas vamos encarar os fatos, nós temos uma ideia melhor de quanto tempo as coisas vão levar comparado ao pobre empreendedor, e ele precisa de nossa ajuda.
...
_"Sim, isso mesmo. A cada duas semanas vamos falar com você sobre o que fazer a seguir. Vamos fazer isso e mostrar para você. Se estiver bom o suficiente, continuamos. Se não, paramos."_

_"Dessa forma, seu risco nunca será maior do que mais $20 mil. Você pode decidir se vai usar esse dinheiro para conseguir mais informação, para redirecionar seus esforços, ou ver se deveria gastar esse dinheiro de alguma outra forma."_

_"Podemos trabalhar dessa forma?"_

Se ele disser sim, vamos começar. Se ele disser não, precisamos descobrir por quê, e mesmo se esse projeto é para nós.
...
Mais do que isso, nós estimamos que um produto viável é provavelmente possível em seis ou nove meses. Se não tivéssemos nenhuma idéia, ou pior ainda, se sinceramente tivéssemos dúvidas disso, então não podemos legitimamente convidá-lo a descobrir - pelo menos não nos termos acima. Nós devemos a ele dizer _"Francamente, isso parece um projeto de dois, três anos para nós. Podemos estar errados: aqui está o que precisamos aprender para descobrir. Aqui está o que custaria para descobrirmos, e nossos melhores chutes agora são que a resposta será má notícia."_

Algumas vezes temos uma boa idéia do que podemos fazer. Algumas vezes sabemos menos. De qualquer jeito, estimando o que sabemos, podemos desenhar experimentos - investimentos - que melhorem nossa capacidade de decidir o que fazer.
...
Uma estimativa não precisa ser _"Este projeto estará terminado na Terça, 14 de Maio, às 14:35h."_ Supõe-se que uma estimativa seja expressa com um intervalo de possibilidades. Seria perfeitamente OK dizer alguma coisa como, _"Não vemos possibilidade de isso ser feito até Abril. Se tudo sair perfeito, podemos estar prontos até meados de Maio. Baseado na nossa experiência, estamos pensando em Junho, talvez Julho."_
...
_"Se você puder remover ou deferir algumas dessas histórias e ainda ter um produto viável, você terá o produto antes. Se puder simplificar, poderá ter o produto antes. Se adicionar histórias, ou tornar as coisas mais difíceis, você vai atrasar o produto pra depois."_
...
Lembre-se de como Agile funciona: desenvolvedores trabalham em um ritmo ótimo sustentável; os desenvolvedores não são responsáveis pelas datas; o lado de negócios é dono das datas, e é dono da responsabilidade de chegar nessas datas.

O trabalho dos desenvolvedores é entregar no melhor ritmo possível: _"Nós achamos que conseguimos fazer três a cinco. Se conseguirmos por acaso ir mais rápido, você vai saber. Se formos mais devagar, você vai saber também. Quando vamos acabar depende disso, mas depende mais ainda de quão pouco você nos dá para fazer. O que será colocado nessas datas depende de você. Você deve planejar em três a cinco itens a cada duas semanas, e checar o que está acontecendo de verdade."_
...
Tudo isso, claro, tem muito mais a ver com comunicação, não com estimativa, e enfaticamente não sobre negociação. A estimativa foi trivial: fizemos logo no começo quando separamos os cartões. Agora estamos comunicando o que sabemos, o que chutamos, o que acreditamos.

Demos à gerência nossas melhores estimativas e taxas de produção, e nos comprometemos com elas, melhorando à medida que vamos evoluindo. Continuamos a deixar claro que o pessoal de negócios controla as datas escolhendo quanto trabalho pedem.
...
Recusar a estimar não é a coisa certa de se fazer. Estimar é necessário, e comunicação efetiva da estimativa é necessária também.

A melhor coisa a fazer é desenvolver funcionalidades pequenas no melhor ritmo sustentável possível, e usar a informação gerada para ajudar as pessoas de negócios decidir o que pedir e o que deferir. Para fazer isso, precisamos estimar. Nós dividimos histórias em tamanhos pequenos estimáveis, e estimamos nossa taxa de entregá-las. Esse tipo de estimativa não é ruim de forma nenhuma: é incrivelmente útil e é o que as melhores equipes ágeis fazem.
