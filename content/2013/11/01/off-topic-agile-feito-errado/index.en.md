...
Agile is another [formula](http://www.akitaonrails.com/2013/10/30/off-topic-matematica-trolls-haters-e-discussoes-de-internet) whose image (result) is the [promise of hyper-productivity](http://www.akitaonrails.com/2009/12/10/off-topic-voce-nao-entende-nada-de-scrum) that can reach 500% of the current. Again, what is the Domain (the premises)?
