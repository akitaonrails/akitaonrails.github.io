...
_The Web is hot, but FTP still beats browsing_. Quarterman also notes that the use of the Windows operating system is declining, and that Macintoshes (despite using the Internet Protocol and not MacOS) and Unix machines are increasing their share of domain control.
