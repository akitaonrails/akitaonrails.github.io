...
My line of thought is always based on [Darwinian Evolutionism](http://akitaonrails.com/en/2007/08/23/off-topic-inimigos-da-razo). It's the only way in which Chaos can tend toward a certain Order through [self-organization](http://akitaonrails.com/en/2009/07/08/off-topic-agilidade-caos-auto-organizacao). This process involves several mechanisms, and it's where I've already given talks on [Scale-Free Networks](http://akitaonrails.com/2008/09/13/off-topic-matando-a-m-dia), on [Complex Adaptive Systems](http://info.abril.com.br/noticias/rede/gestao20/gestao/off-topic-complexidade-em-biologia/), and how all of that leads to [processes, methodologies](http://info.abril.com.br/noticias/rede/gestao20/gestao/processos-metodologias-e-o-cerebro-humano/), including the much-discussed [Scrum](http://akitaonrails.com/en/2009/12/10/off-topic-voce-nao-entende-nada-de-scrum). This line of study — which you can follow in my blogs and talks of the last 3 years — passes superficially through topics of biology, sociology, psychology, philosophy, physics, mathematics. Ultimately it seemed to me that the most coherent path was around what today has become known as [Democratic Organizations](http://www.worldblu.com/democratic-design/), especially because of famous _cases_ like [Semco, of Ricardo Semler](http://info.abril.com.br/noticias/rede/gestao20/gestao/minha-primeira-visita-a-semco/) and aspects of democracy in organizations that can be observed in companies like Southwest Airlines, Dreamhost, Groupon, Zappos.

However, I myself was a victim of what I always criticize: a group of positive evidence about a model, however good they may seem, never proves the model! Concluding based only on positive evidence is the same as [cargo cult](http://akitaonrails.com/en/2008/12/16/off-topic-m-todo-cient-fico-vs-cargo-cult). So the first thing I must correct is: the type of organization I describe and defend has nothing to do with "Democracy," so in my conception, the term "Democratic Organizations" is a **mistake**.
...
I don't defend the owner of this site nor all of his ideas, but the text he wrote serves my purposes, so I decided to translate it directly. For the original, access this article by [Gary McLeod](http://www.garymcleod.org/republic.htm). If you search Google for "democracy vs republic," you'll find hundreds of articles explaining the differences in more detail. But for now this one serves. Here's the translation:
...
If you research at least the Wikipedia articles on [Democracy](http://en.wikipedia.org/wiki/Democracy) and [Republic](http://en.wikipedia.org/wiki/Republic), you'll see that the subject is much more complex than this.

What I most admire when we talk about the [Founding Fathers of the United States](http://en.wikipedia.org/wiki/Founding_Fathers_of_the_United_States) was that philosophical and political clarity that led them to describe a Republic based on inalienable Individual Rights, generating solid foundations like the [Declaration of Independence](http://en.wikipedia.org/wiki/United_States_Declaration_of_Independence) and the [Bill of Rights](http://en.wikipedia.org/wiki/United_States_Bill_of_Rights). Of course, I'm not saying they were perfect people — they all had a thousand flaws, but don't get hung up on that (after all, that would be the [Straw Man Fallacy](http://en.wikipedia.org/wiki/Straw_man)).
...
There's no "official" document that describes its principles, so I'll borrow the list of principles described by [WorldBlu](http://www.worldblu.com/democratic-design/principles.php), an organization that tries to spread the idea of Democratic Organizations around the world. Read on their page for more details, but in summary, we have the following principles:

1. Purpose and Vision — normal, any company needs to have this clear, what its core business is, and what it exists for.
2. Transparency — there are controversies, not everything can be open, including some things are actually legally protected.
3. Dialogue + Listening — I agree, the concept is valid, and against top-down authoritarianism.
4. Equality + Dignity — hard to define, some differences in treatment are more cultural than mandatory.
5. "Accountability" — hard to translate into Portuguese, but it's something like "Responsibility," but in this concept it's more about better defining who is responsible for what.
6. Individual + Collective — this is where the whole concept starts to fall apart.
7. Choice — implementable, but within limits.
8. Integrity — mentions "morally" and "ethically" correct. That's a problem.
9. Decentralization — instead of centralization, I'm always in favor of this, but within limits.
10. Reflection + Evaluation — a "touch" of Toyota's Hansei+Kaizen model.
...
My problem with these _principles_: they are rhetorical, and therefore don't serve as _principles_. Simply saying, "it has to be transparent" is rhetorical. I can tell you I never told a lie — and who's going to disprove me?

The same goes for "dialogue," "dignity" — they're good rhetoric, but they're descriptions of conduct, that is, they're the process and not the foundation. They don't deal with the real principle: _"Why should I act this way?"_
...
And "rights," to be clear, isn't just anything. Like, for example, _"right to bonuses,"_ _"right to more rest hours per week."_ Everything needs to fall into the fundamental problem of any organization: _"And who pays the bill?"_ If for one individual to have a right, another individual needs to work for free, that defines slavery and, by definition, cannot be a right. Read my article on [Rights of Man](http://akitaonrails.com/2009/09/09/off-topic-direitos-do-homem) to understand this.
...
Let's get to the foundation of all this: every company and organization is **private property** of its owner, partners, or shareholders. It does **not** belong to the employees unless they are also shareholders of the company, for example, via a _stock options_ program or something of the sort.

Employees are individuals who are trading their capabilities and voluntary work hours, in a voluntary negotiation with the company for a value called "salary." It's a fair, voluntary negotiation, for [mutual benefit](http://akitaonrails.com/2011/02/03/off-topic-a-revolta-de-atlas-dinheiro-e-a-raiz-de-todo-o-mal). The employee's right ends where what is written in their work contract, duly signed, ends. There's nothing to be "claimed."
...
Here's the _key point_ of this whole article: **these cases of Democratic Organizations are not necessarily Democratic**. At least not as people imagine it should be.
