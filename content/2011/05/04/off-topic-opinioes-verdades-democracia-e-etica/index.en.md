...
At no point does it say that the Team can be anarchic. But people read the concept of [self-organization](http://akitaonrails.com/2009/07/08/off-topic-agilidade-caos-auto-organizacao) incorrectly as "_we do as we want_." And that is completely wrong.
...
And here comes the difference between a professional and an amateur: [**professional ethics**](http://en.wikipedia.org/wiki/Professional_ethics).
...
The tradition of medicine, for example, is in the inheritance of the [Hippocratic Oath](http://en.wikipedia.org/wiki/Hippocratic_Oath), for millennia being updated and the following is the modern version:
...
- stop using "democracy" with [populist](http://en.wikipedia.org/wiki/Populism) connotations. It's not merely the "team" that must be "protected" or "benefited," but rather the client's result and their projects. Never forget that.
...
- show a little respect and dignity to your profession. You work, in fact, for your own benefit, but never causing harm to others. I will repeat this _ad nauseum_: you only have work because there's someone willing to pay for it, be ethical, be professional.
