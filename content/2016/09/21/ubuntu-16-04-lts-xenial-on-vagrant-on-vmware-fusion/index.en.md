...
Then I upgrade packages and install the basics:
...
The only 2 tweaks I have to do are changing my [iTerm2](https://github.com/altercation/solarized/tree/master/iterm2-colors-solarized) profile to use [Solarized](http://ethanschoonover.com/solarized), and adding the following 2 lines to the top of the `.vimrc` file:
...
Leiningen will install its dependencies and you can follow its [tutorial](https://github.com/technomancy/leiningen/blob/stable/doc/TUTORIAL.md) to get started.
...
Once you install go and set its work path, we can install some useful tools such as [forego](https://github.com/ddollar/forego) and [goon](https://github.com/alco/goon#goon) (that Elixir's Hex can optionally use):
