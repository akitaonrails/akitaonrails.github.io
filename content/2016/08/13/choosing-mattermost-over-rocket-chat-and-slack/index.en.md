...
description: "I tested Slack, Rocket.chat, and Mattermost with nearly 50 people, and we ended up on Mattermost: its interface was faster and more responsive, though installation required Docker, Go, and hacks."
tags:
- reviews
- containers
draft: false
...
So I changed my `GOPATH` to `/Users/akitaonrails/Sites/go` and the project to `/Users/akitaonrails/Sites/go/src/github.com/mattermost/platform` and now it works. I would probably have symlinked the project path to be inside the GOPATH as well. But now everything compiles and runs just fine.
