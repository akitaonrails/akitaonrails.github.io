...
* Velocity is the actual amount of story points delivered by the end of a Sprint.
    ...
    - The Product Owner sole responsibility is to be accountable for the Return on Investment of the implemented features. And the only way to measure cost-benefit is to know "how much" a feature will "cost" in terms of story points divided by velocity.
