...
Sometimes I see these childish, meaningless manifestations of anti-Americanism — usually from kids wearing Nike, watching ESPN, eating frequently at McDonald's, listening to Coldplay and Dream Theater. I think to myself: _why do I sense, beneath all that fury, a hint of **envy**, **insecurity**, and **low self-esteem**?_

 ![](/files/mrbean.jpg)

I don't know if that's what it is — and I have zero interest in investigating further — but that's what it looks like. Honestly. Everyone criticizes what they think they can't have, trying to disguise that pang of envy. _Money can't buy happiness_, yadda yadda. _Americans are imperialists_, yeah yeah yeah.
...
Honestly, when someone asks me a direct question, I give a direct answer. If someone asks, _Do you know English?_, I answer, _Of course._
...
I'm not talking about the type who claims to know everything but knows nothing. That's not arrogance — it's **stupidity**, pure and simple, because sooner or later the mask slips. Though sometimes it doesn't, and even a complete idiot manages to do well. That's because they got lucky surrounding themselves with people inferior to them — _in the land of the blind…_

As a friend once put it, _it's a sin to leave an idiot with their own money_. True.
...
If someone asks me: _Do you know X?_, I have only two direct answers: **Yes** or **No**. Saying _no_ once in a while is forgivable, acceptable. Saying _no_ frequently is defeatist. _What do you mean you don't know something as basic as X?_ Saying _no_ all the time is admitting a weakness. Always saying no is admitting your own incompetence.

That's why nobody just says _No_. Instead they prefer to say _more or less_, _I think so_, _almost there_. The way I see it: _no_ and _maybe_ are the same thing — neither of them is _Yes_.

Now, if you say _Yes_ frequently, prepare to be hammered. Nobody likes people who always say _Yes_, because they feel diminished: _How come he knows and I don't?_ And because of that everyone will try to knock you down, out of pure pettiness. They'll even say, _big deal that he knows — I could know that too_. You _could_ — but you don't.
...
Easier said than done. Obviously — that's what makes people who say Yes unique. Everyone else: those who say _No_ — the losers — and those who say _more or less_ — the wafflers, is what we call _the average_.

#### Average of the Average

_And what's wrong with being average? Why do I need to be different from everyone?_
...
And why this insistence on talking about _average_? Because nobody seems to care. Because everyone seems to think it's **good** to be average.

I want everyone to remember one thing: the word _average_ is the root of another: **Mediocre** — and I guarantee nobody feels flattered being called mediocre. Remember that the next time you think it's fine to consider yourself part of the _average_.

 ![](/files/Graduation.jpg)

After all that semantics, I return to the excuse — I mean, topic — that originated this post: English. And what does all of this have to do with it? Because the overwhelming majority of Brazilians belong to the camp of _No_ and _more or less_. Not knowing English, or knowing it _more or less_, makes them part of the _average_. In my view, that makes them purely and simply mediocre.
...
Most people don't become fluent. I've known many who took 5 years of good courses and still speak poorly. Embarrassingly poorly. I've seen celebrities on TV, educated people, who make me cringe. I feel uncomfortable watching acquaintances speak that _Portu-glish_, or whatever they call it.
...
Beyond just reading in English, I had the luck of witnessing the birth of the mass internet. Back then there were no localized browsers, no Portuguese-language operating systems, no software in Portuguese. Everything at university was in English: a black-and-white terminal, a few Unix commands, and basically willpower. I could have said _No_ and finished university exactly like everyone else, or I could say _Yes_ and figure it out.
...
Which ones do I listen to? My favorites are the [TWiT.tv](http://www.twit.tv) network, led by the easygoing Leo Laporte with guests on shows like [This WEEK in TECH](http://www.twit.tv/TWiT) featuring the sharp John Dvorak, Merlin Man, and others. Steve Gibson on [Security Now!](http://www.twit.tv/SN). Paul Thurrott on [Windows Weekly](http://www.twit.tv/ww). Merlin Man, Alex Lindsay, and Scott Bourne on [MacBreak Weekly](http://www.twit.tv/mbw). Chris DiBona on [FLOSS Weekly](http://www.twit.tv/FLOSS).

[![](/files/veronicabelmont.jpg)](http://www.veronicabelmont.com/)

Speaking of John Dvorak, his controversies also live on his own show [Cranky Geeks](http://www.crankygeeks.com/). I've followed Dvorak for years — since the early 90s in PC Magazine. There's also Patrick Norton on [DL.tv](http://dl.tv/). [Cali Lewis](http://geekbriefwp.podshow.com/) from GeekBrief|TV doesn't break any big news I don't already know, but her charm is worth 5 minutes of the show. Same goes for the equally charming (it's always good to hear female voices) Veronica Belmont on the daily show (yes, interesting news, **EVERY DAY!**) from C|Net, [Buzz Out Loud](http://reviews.cnet.com/4520-11455_7-6457370-1.html).
...
The [Revision3](http://revision3.com) channel is also right up there, with the great [Diggnation](http://revision3.com/diggnation) featuring Kevin Rose commenting on the front-page stories from the excellent [Digg.com](http://www.digg.com). Anyone who wants to be well-informed has practically an obligation to follow Digg. And once again, people frustrate me. How can you go around trying to talk about Web 2.0 and all that blah blah blah without knowing what's happening in Silicon Valley? Nobody read Business Week's [Valley Boys](http://www.businessweek.com/magazine/content/06_33/b3997001.htm) from last year? Kevin Rose is one of the representatives of the new generation of young, wealthy internet entrepreneurs and Podcasting is one of the biggest Tech media channels today.

Finally, back to the reading side: my routine involves [Google Reader](http://reader.google.com). As I mentioned, I have about 90 RSS websites aggregated in Reader. During the day, between 50 and 100 new stories arrive per hour. I don't read all of them. In a day I might read a dozen solid pieces. First, it takes experience and knowledge to distinguish junk from useful content. Second, it takes dynamic reading — just scanning and moving on. I can go through 100 news items in 15 minutes, and I guarantee I don't miss anything important.
...
I have one more argument. When I meet someone with more knowledge or skill in my field than I have, I just think: _he's as human as I am_ — so whatever he did to know more, I can do too. Everything is achievable. There is no end. Because for every ceiling there's always a higher one. It's simply a matter of stopping saying _No_, _more or less_, _maybe_.
...
If you don't, read [this](http://www.google.com/help/reader/faq.html#import) link and [this](http://www.apple.com/itunes/store/podcaststips.html) one.
...
Why so much _promotion_ of podcasts? Simple: because it's the most practical way to absorb tons of high-quality informational content to practice that dreaded _listening_. Forget those horrible cassette-based language courses. Learn from the real thing.
