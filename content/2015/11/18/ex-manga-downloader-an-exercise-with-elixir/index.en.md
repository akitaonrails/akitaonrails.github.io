...
[Enum](http://elixir-lang.org/docs/stable/elixir/Enum.html) is one of the most useful modules you need to master. If you come from Ruby it feels like home, you must learn all of its functions. You're usually having to transform one collection into another, so it's important to study it thoroughly.
...
This has been a very fun experience, albeit very short, and good enough to iron out what I have learned so far. Code like this makes me smile:
