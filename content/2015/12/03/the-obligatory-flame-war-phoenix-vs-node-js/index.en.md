...
On their websites, ejabberd calls itself a "Robust, Scalable, and Extensible XMPP Server," and RabbitMQ calls itself "Robust messaging for applications." Now we know they deserve the labels "Robust" and "Scalable."
