...
And now the following calls are all equivalent:
...
The special "__using__" macro is called when I "use" a module, and I can even pass arguments to it. The implementation then uses "apply/3" to dynamically call the correct macro. This is exactly how Phoenix imports the proper behaviors for Models, Views, Controllers, Router, for example:
