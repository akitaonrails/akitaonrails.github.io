...
Like all of Seth Godin's writing, this 2005 book is also fun to read (in my case, [listen to](http://tinyurl.com/allmarketersareliars)). Despite being old, it outlines an interesting model of marketing.
...
This brings me to myself. It's a small case, but I don't recall having talked about it. When 37signals made their book [Getting Real](http://gettingreal.37signals.com/GR_por.php) available online, I was certain it should be the first material for the Brazilian Rails community. At the time there wasn't much Ruby or Rails material in Portuguese — some thought I should have gone after that first: translating reference guides, tutorials and other things to help programmers get started.

But I was certain it should be the opposite. I wanted to translate Getting Real because it would set the "tone" of the community, its philosophy, values and pragmatism — at least that was my _wishful thinking_. So, on [November 13, 2006](http://akitaonrails.com/2006/11/13/vamos-traduzir-o-livro-getting-real) I made the first _call-to-arms_ and, after excellent collective work from the community, we were able to finish on [March 26, 2007](http://akitaonrails.com/2007/03/26/getting-real-tradução-completa-chegamos-ao-1-0). I know not everyone read that book, but I believe it helped inspire the first Rails entrepreneurs in Brazil.
