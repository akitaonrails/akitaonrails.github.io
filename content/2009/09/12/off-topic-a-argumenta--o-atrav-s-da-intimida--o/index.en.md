...
This method has a certain similarity to the [ad hominem](http://pt.wikipedia.org/wiki/Argumentum_ad_hominem) fallacy, comes from the same psychological root, but is essentially different. The ad hominem fallacy consists in trying to counter an argument by accusing the character of its proponent. Example: "candidate X is immoral, since his argument is false."
...
The classic example of the intimidation argument is the story [The Emperor's New Clothes](http://tinyurl.com/qlmbw7)
