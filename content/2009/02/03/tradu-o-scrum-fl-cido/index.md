...
5 dias atrás, Martin Fowler [escreveu um artigo](http://martinfowler.com/bliki/FlaccidScrum.html) que pode ser um pouco polêmico para Scrummers, mas não vejam isso como uma crítica ao Scrum e sim como uma crítica a quem aplica Scrum da maneira errada e a quem não se preocupar em tornar isso aparente. A seguir eu traduzi o artigo dele na íntegra, e no final coloquei alguns comentários meus.
