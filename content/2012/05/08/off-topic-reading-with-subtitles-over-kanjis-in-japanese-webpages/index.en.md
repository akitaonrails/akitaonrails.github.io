...
I've known of a Firefox add-on I'm very fond of for a long time now called [Rikaichan](https://addons.mozilla.org/pt-BR/firefox/addon/rikaichan/). When enabled, you hover your mouse over the kanji text and it will popup a box with the translation. You must install the Firefox add-on in the previous link and a proper dictionary to your native language from [Rikaichan's webpage](http://www.polarcloud.com/rikaichan/). And that's it.
