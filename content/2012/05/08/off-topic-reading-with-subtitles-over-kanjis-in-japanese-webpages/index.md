...
Eu já conheço há bastante tempo um add-on do Firefox do qual gosto muito, chamado [Rikaichan](http://web.archive.org/web/20120624074033/https://addons.mozilla.org/pt-br/firefox/addon/rikaichan/). Quando habilitado, basta passar o mouse sobre o texto em kanji e ele abre um popup com a tradução. Você instala o add-on do Firefox no link acima e um dicionário apropriado para o seu idioma nativo a partir da [página do Rikaichan](http://web.archive.org/web/20120512063523/http://polarcloud.com/rikaichan). E pronto.
...
Mas se você gosta de ler mangá (quadrinhos japoneses), provavelmente conhece o Furigana. É mais ou menos como "legendar" os Kanjis com Hiragana ou Katakana, os silabários japoneses (o primeiro para palavras puramente japonesas, o segundo para palavras estrangeiras).

Isso deixa a leitura dos Kanjis mais difíceis muito mais fácil e rápida do que ficar passando o mouse em cada um ou consultando o dicionário ideograma por ideograma.
...
Mas com o [Furigana Inserter](http://web.archive.org/web/20131115215917/https://addons.mozilla.org/pt-BR/firefox/addon/furigana-inserter/) o mesmo trecho fica assim:
...
Para instalar, primeiro você instala o [add-on](http://web.archive.org/web/20131115215917/https://addons.mozilla.org/pt-BR/firefox/addon/furigana-inserter/). Depois instala também o add-on [HTML Ruby](http://web.archive.org/web/20130501123822/https://addons.mozilla.org/en-US/firefox/addon/html-ruby/). Por fim, instala este [dicionário](http://web.archive.org/web/20111115202242/http://code.google.com:80/p/itadaki/downloads/detail?name=furiganainserter-dictionary-1.2.7z). É um arquivo 7-zip que você descompacta e arrasta manualmente sobre o Firefox para instalar.
