...
* * *
css background: image-url(“rails.png”) no-repeat;
* * *
...
var imagem = “\<%= image\_path(”rails.png") \>";  
var tag\_imagem = "\<= image\_tag(“rails.png”) \>";  
var audio = "\<= audio\_path(“rails.mp3”) \>";  
var tag\_audio = "\<= image\_tag(“rails.mp3”) \>";  
var video = "\<= video\_path(“rails.m4v”) \>";  
var tag\_video = "\<= image\_tag(“rails.m4v”) %\>";  
-
...
1. gzip\_vary on;
2. gzip\_proxied any;
3. gzip\_comp\_level 6;
4. gzip\_buffers 16 8k;
5. gzip\_http\_version 1.1;
6. gzip\_types text/plain text/css application/json application/x-javascript text/xml application/xml application/xml+rss text/javascript;  
-
