...
This Intel NUC runs a headless Ubuntu Server LTS (no desktop manager), which I access only via SSH (as I explained in the [previous post about SSH](https://akitaonrails.com/en/2025/09/09/omarchy-2-0-understanding-ssh-and-yubikeys/)). On it I run things like Portainer, Plex, Sonarr, Bazarr, qBitTorrent and much more.
