...
So this setup is meant to be pure Linux, with access to my **Synology DS 1821+ NAS** with 100TB. The only extra thing I'll need is to configure NFS mounts, as I've already detailed in [this other post](https://akitaonrails.com/2025/04/17/configurando-meu-nas-synology-com-nfs-no-linux/).
...
This will let me stop worrying about Docker filling my drive and freezing my entire system from lack of space. Last time I had "solved" this by making a [remote drive with iSCSI](https://akitaonrails.com/2025/04/17/configurando-meu-nas-synology-com-nfs-no-linux/) on my NAS (which has infinite space). Since removing my Steam VM will give me 2TB back, I'll solve the problem locally and with fewer configurations.
...
There are two solutions: try to change the UID on the NAS from 1026 to 1000. [I tried that](https://akitaonrails.com/2025/04/17/configurando-meu-nas-synology-com-nfs-no-linux/) and I'll tell you up front it's a waste of time, you can end up breaking your NAS's configurations catastrophically.
