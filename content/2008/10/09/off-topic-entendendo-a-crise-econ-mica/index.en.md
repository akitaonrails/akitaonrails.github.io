...
[Nassim Taleb](http://en.wikipedia.org/wiki/Nassim_taleb) and [Benoît Mandelbrot](http://en.wikipedia.org/wiki/Benoît_Mandelbrot) must be watching this crisis with very different eyes from the rest of us — tragically, in a way. Some people are probably tired of this, but I'll repeat my recommendation to read the works of both.

![](http://s3.amazonaws.com/akitaonrails/assets/2008/10/9/n1a7_blackswan.jpg)

See this excerpt from [The Black Swan](http://www.amazon.com/Black-Swan-Impact-Highly-Improbable/dp/1400063515/ref=sr_1_1?ie=UTF8&s=books&qid=1223360749&sr=1-1), from 2006, by Nassim Taleb:
...
[Long-Term Capital Management](http://en.wikipedia.org/wiki/Long-Term_Capital_Management) was the darling of the financial world. An American hedge fund formed in 1997, which had among its founders not just one, but **two** Nobel Prize winners in Economics: Robert C. Merton and Myron Scholes. They believed they had the mathematics (cough Gaussian cough) capable of predicting any type of event. In 1998, LTCM already owed USD 4.6 billion. The [Russian Financial Crisis](http://en.wikipedia.org/wiki/Russian_financial_crises) destroyed their Gaussian theories, which completely ignored and underestimated Black Swans.
...
If your client succeeds after implementing the methodology: _"See? You succeeded because you implemented our revolutionary methodology."_ Of course this client then becomes a "success case" in their portfolios.

If your client fails after implementing the methodology: _"Of course it failed — you didn't implement it exactly as we said, your teams lacked commitment. There's nothing wrong with our methodology, just with you."_ And, obviously, this client will never appear in the portfolio, since nobody likes publicizing failures.
...
People have the terrible habit of asking the wrong questions: _"How do we know if a theory is true?"_ That's exactly why they also receive the wrong answers, which leads to even more wrong decisions.
...
Every time we see a "success case," we automatically accept the theory as "true." Or in an even more twisted way: _"I've never heard of a case where this methodology failed, so it must only be valid."_ That's the conclusion most "managers" and "executives" reach. How many times do we need to repeat this?
...
What past data can do, at most, is ensure the **falsifiability** of a theory. As Nassim explains in [Fooled by Randomness](http://www.amazon.com/Fooled-Randomness-Hidden-Chance-Markets/dp/1400067936/ref=sr_1_3?ie=UTF8&s=books&qid=1223360749&sr=1-3): with past data we can indeed prove that a theory is invalid, but we can **never** prove that a theory is valid.
...
Nassim gave another great example: _"I've been conducting a study on George Bush's life. After 20,000 observations I can assure you that in none of them did he die. Therefore I can state with certainty, based on this historical data, that Bush has never died, therefore he is immortal."_
...
The "beautiful" theory only exists today simply because it hasn't yet encountered a Black Swan in its path. _"Ah, it'll never happen because it's never happened until now."_ And that's precisely why there may be, perhaps, even more chances of it happening: because it never has!
...
- **Narrative Fallacy:** the creation of a [post-hoc](http://en.wikipedia.org/wiki/Post-hoc) story such that the event seems to have had an identifiable cause.
...
- very small variations in data can lead to enormous impact ([Butterfly Effect](http://en.wikipedia.org/wiki/Butterfly_effect) — yes, it happens **all the time**)
- theories/models based on empirical data are flawed, since events that haven't happened yet cannot be taken into account

It's the example Taleb explains: suppose you're pulling colored balls from a covered box — without being able to see. You draw 5 white balls and 5 red balls and, from this empirical data, reach the conclusion that _"**always** 1 red ball will come out for every 2 balls drawn."_ But little do you know that under the table there's a hole and there's a boy hiding there. Upon hearing your assertion, he starts giving you more white balls than red. That's reality.
...
As Malcolm Gladwell says in [Blink](http://www.amazon.com/Blink-Power-Thinking-Without/dp/0316010669/ref=sr_1_3?ie=UTF8&s=books&qid=1223360700&sr=1-3): we effectively make decisions in the blink of an eye. Of course, the decision will be only as good as our experience, knowledge, and skills.
...
_"Excellent!"_ someone might think: here is a 100% **rational** person, who won't let emotions interfere with reason. You could deduce that this person would be capable of making intelligent and rational decisions.
