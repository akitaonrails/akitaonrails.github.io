...
**Update 21/04/2008:** This post by [Paulino Michelazzo](http://www.michelazzo.com.br/node/393) is very good. Recommended.

Rodrigo Kumpera [said it all](http://www.kumpera.net/blog/index.php/2008/04/16/vamos-todos-impedir-a-regulamentacao-da-profissao-de-analista-de-sistema/) — this 'systems analyst' regulation law is a complete waste of time and an enormous piece of nonsense.
...
_"Civil Engineers, Cardiologists, Criminal Lawyers, Accountants — all of them need degrees, all of them need licenses to work, all of them pay regulatory councils, in short, all of them are 'regulated.' Why do programmers, analysts, and computer scientists think they're more 'special' and don't need any of this?"_

This is the main argument and the key to this fallacy.

First, let's break the premise of this fallacy: that _"software developer belongs in the same category as civil engineer, doctor, or lawyer."_
...
The erroneous comparison goes like this: if an "inexperienced" programmer makes a mistake and leaves a _bug_ behind, a computer-controlled airplane could crash. A computer-controlled elevator could plummet. A medical electronic device could kill a patient. A computerized car could crash.
...
That's not the case. I wouldn't go as far as **Pete McBreen** in [Software Craftsmanship](http://www.amazon.com/Software-Craftsmanship-Imperative-Pete-McBreen/dp/0201733862), but it's undeniable that most people start from the wrong premises when evaluating software.
...
No, the problem here is the [Informal Fallacy](http://en.wikipedia.org/wiki/Informal_fallacy):

_"Many great computer programmers have degrees. Therefore, the key to becoming a great programmer is getting a degree."_

Given the two scenarios above — artists and programmers — I'd say this:

_"Great programmers are not formed. Great programmers **form themselves**."_
...
_"Good professionals are not formed. Good professionals form themselves. Good professionals, in Brazil, tragically may end up being pushed to become terrible professionals."_

_"Terrible professionals are not formed. Terrible professionals will always be terrible. There is no hope for them."_
