---
title: Rails Podcast Brasil, Especial QCon - Yehuda Katz
date: '2008-11-19T08:06:00-02:00'
slug: rails-podcast-brasil-especial-qcon-yehuda-katz
translationKey: qcon-special-yehuda-katz
aliases:
- /2008/11/19/rails-podcast-brasil-qcon-special-yehuda-katz/
description: "Em episódio especial na QCon, entrevistei Yehuda Katz sobre Merb, DataMapper e modularidade. Ele contrapõe a arquitetura do Merb à visão de Rails, mas vê a divergência como debate produtivo."
tags:
- qcon2008
draft: false
---
...
O problema principal é em torno de Modularidade. O ponto de vista do DHH é que Rails é modular o suficiente e você pode soltar alguns dos componentes. Mas o argumento do Yehuda é que isso requer que você faça remendos no Rails para liberá-lo de alguns componentes, enquanto o Merb já é construído sobre o conceito de modularidade desde o começo. Algumas pessoas ficaram preocupadas que mais uma Guerra Fria estivesse começando mas Yehuda diz [que esse não é o caso](http://yehudakatz.com/2008/11/16/mythbusting-we-agree-ruby-is-awesome/) e que discussões abertas como essa são na realidade boas, em vez de críticas por baixo dos panos.
