...
Fortunately, I had the chance to experiment with its beta release in a controlled Vagrant environment and check those claims! Bear in mind that those are synthetic benchmarks and real world throughput of real applications should give us different behavior. With that having been said, let's see how the main Ruby servers perform a very simple Rack app returning a simple HTTP 200 with "Hello World":
