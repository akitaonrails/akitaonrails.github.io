...
I've got an RTX 5090 with 32 GB of GDDR7. I know I can run the latest open source models. I bought a [Minisforum MS-S1](/en/2026/03/31/minisforum-ms-s1-max-amd-ai-max-395-review/) with an AMD Ryzen AI Max 395 and 128 GB of unified memory, and built a [home server with Docker](https://akitaonrails.com/2026/03/31/migrando-meu-home-server-com-claude-code/) to serve local models. The infrastructure was ready. What was missing was actually testing it.
