...
FrankMD was the first project in this saga, a self-hosted Markdown editor with Rails 8. The [February posts](/2026/02/01/vibe-code-fiz-um-editor-de-markdown-do-zero-com-claude-code-frankmd-part-1/) covered the build. What happened after is more interesting: other people started contributing.
...
FrankMega was built in [1 day](/2026/02/21/vibe-code-fiz-um-clone-do-mega-em-rails-em-1-dia-pro-meu-home-server/). 26 commits, secure file sharing with Rails 8, 210 tests, deploy via Docker + Cloudflare Tunnel. Post published the same day. Done, right?
