...
The operating system is openSUSE MicroOS (more on that in the [next post](/2026/03/31/migrando-meu-home-server-com-claude-code/)). The whole machine pulls under 100W, which is absurd if you're used to dedicated GPUs that draw 450W+ on their own.
