...
Talvez o Fable seja muito melhor em outras tarefas. O marketing dele é todo em volta de capacidade de análise de segurança, e essa capacidade está literalmente bloqueada na versão pública (quando não está bloqueando "hello"). E aqui cabe uma especulação que eu não consigo evitar. A própria Anthropic documentou que tarefas consideradas "de risco" são redirecionadas pro Opus 4.8. Com um resultado tão colado no do Opus, fica a pulga atrás da orelha: será que não estão redirecionando demais? Quanto do meu benchmark foi respondido pelo Fable de verdade, e quanto caiu no fallback? De fora, não dá pra auditar. Pode ser que o Fable empate honestamente com o Opus em coding. Pode ser que eu tenha medido o Opus usando crachá de Fable. As duas hipóteses produzem exatamente o mesmo número na tabela. No que dá pra medir aqui, é um Opus mais caro.
