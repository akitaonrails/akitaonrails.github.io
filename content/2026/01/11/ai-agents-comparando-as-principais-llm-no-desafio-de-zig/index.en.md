...
> I explained this last year in the article [Dissecting an Ollama Modelfile](https://akitaonrails.com/2025/04/29/dissecando-um-modelfile-de-ollama-ajustando-qwen3-pra-codigo/). But remember the process: for each new round to generate the **next token** it will calculate and find several candidates, each with a certain probability.
