...
> Exposing services on the internet is DANGEROUS. That's why I wrote [this article explaining how to use real domains](https://akitaonrails.com/en/2025/09/09/accessing-my-home-server-with-a-real-domain/) and [this other article about using Cloudflare Zero Trust](https://akitaonrails.com/en/2025/09/10/protecting-your-home-server-with-cloudflare-zero-trust/).
