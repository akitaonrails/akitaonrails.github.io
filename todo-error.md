# Translation errors / remaining (to be translated in a fresh session)

These posts hit API 400 errors or were not reached due to session limits during the batch translation run. They should be picked up in a fresh session.

- content/2007/06/13/off-topic-steve-jobs-discurso-em-stanford-2005/index.md
...
- content/2011/05/04/off-topic-opinioes-verdades-democracia-e-etica/index.md (PERMANENT SKIP — persistent API 400, do not retry)
