...
FEATURED_POSTS = [
  ...
  ['2026-04-18', 'LLM Benchmarks Parte 2: Vale Combinar Múltiplos Modelos no Mesmo Projeto? Claude + GLM??', '/2026/04/18/llm-benchmarks-parte-2-multiplos-modelos/'],
...
FEATURED_POSTS_EN = [
  ...
  ['2026-04-18', 'LLM Benchmarks Part 2: Is It Worth Combining Multiple Models in the Same Project? Claude + GLM??', '/en/2026/04/18/llm-benchmarks-part-2-multi-model/'],
